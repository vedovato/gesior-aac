...
if ($action == "") {
	...
	$guild_level_system_url = '?subtopic=guildlevel';
	...
	if (count($guilds_list) > 0) {
		foreach ($guilds_list as $guild) {
			...
			$guild_points = $guild->getPoints();
			$guild_maxPoints = 1500000;
			$newlines = array("\r\n", "\n", "\r");
														...
														<div id="AdministrationContainer">
															...
															<table border="0" cellspacing="0" cellpadding="0" >
																<form action="?subtopic=guilds" method="post" >
																	<tr>
																		<td style="border:0px;" >
																			<input type="hidden" name=action value=activitylog >
																			<input type="hidden" name=GuildName value="' . $_REQUEST['GuildName'] . '" >
																			<div class="BigButton" style="background-image:url(' . $layout_name . '/images/global/buttons/sbutton.gif)" >
																				<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" ><div class="BigButtonOver" style="background-image:url(' . $layout_name . '/images/global/buttons/sbutton_over.gif);" ></div>
																					<input class="ButtonText" type="image" name="Guild Activity Log" alt="Guild Activity Log" src="' . $layout_name . '/images/global/buttons/_sbutton_guildactivitylog.gif" >
																				</div>
																			</div>
																		</td>
																	</tr>
										...
										<td>
											...
											<div class="TableContentAndRightShadow" style="background-image:url(' . $layout_name . '/images/global/content/table-shadow-rm.gif);" >
												<div class="TableContentContainer" >
													...
													<tr style="background-color:#D4C0A1;" class="LabelH">
														<td>Level</td>
														<td>Points</td>
		...
		if ($logged) {
			...
			if ($guild_vice)
				$main_content .= '
						<TD>
							<table border="0" cellspacing="0" cellpadding="0" >
								<form action="?subtopic=guilds&action=members" method="post" >
									<tr>
										<td style="border:0px;" >
			...
			if ($guild_leader)
				...
				$main_content .= '
							<TD>
								<table border="0" cellspacing="0" cellpadding="0" >
									<form action="?subtopic=guilds&action=ranks" method="post" >
										<tr>
											<td style="border:0px;" >
...
<div class="TableContainer">
	<div class="CaptionContainer">
		<div class="CaptionInnerContainer"> <span class="CaptionEdgeLeftTop" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-edge.gif);"></span> <span class="CaptionEdgeRightTop" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-edge.gif);"></span> <span class="CaptionBorderTop" style="background-image:url(' . $layout_name . '/images/global/content/table-headline-border.gif);"></span> <span class="CaptionVerticalLeft" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-vertical.gif);"></span>
		<div class="Text">Guild Transfer Log - Last 10 Entries</div> <span class="CaptionVerticalRight" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-vertical.gif);"></span> <span class="CaptionBorderBottom" style="background-image:url(' . $layout_name . '/images/global/content/table-headline-border.gif);"></span> <span class="CaptionEdgeLeftBottom" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-edge.gif);"></span> <span class="CaptionEdgeRightBottom" style="background-image:url(' . $layout_name . '/images/global/content/box-frame-edge.gif);"></span> </div>
	</div>
	<table class="Table3" cellpadding="0" cellspacing="0">
		<tbody>
			<tr>
...
<table border="0" style="width:100%;">
	<tbody>
		...
		$main_content .= ' You\'re not leader of this guild!!';
	}
}
