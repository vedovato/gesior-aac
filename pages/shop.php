...
if (!$descontinuado) {
	...
	$main_content .= '
		...
		<p>Below you will see some services that we offer in our online shop, also extra services, mounts, outfits and items. This shop is simply for you to be inside of new offers that will be shown here, because to make the purchase you must go to the <a href="?subtopic=accountmanagement&action=manage#Products+Available">page of your account</a>.</p>';
